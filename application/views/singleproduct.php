...
<div class="shop-detail-box-main">
    ...
    <div class="carousel-item <?php echo $index === 0 ? 'active' : ''; ?>">
        <img class="d-block w-100" src="<?=  $image['url_thumbnail']; ?>" alt="<?=  $image['url_thumbnail']; ?>">
    </div>
                    ...
                    <div class="single-product-details">
						...
						<div class="price-box-bar">
							<div class="cart-and-bay-btn">
								<a class="btn hvr-hover" data-fancybox-close="" href="<?=base_url()?>checkout/index/1">Beli</a>
							</div>
						</div>
